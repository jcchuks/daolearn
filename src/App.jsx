...
const App = () => {
  ...
  useEffect(()=>{
    ...
    voteModule.hasVoted(proposals[0].proposalId, address).then((hasJustVoted) => {
      setHasVoted(hasJustVoted);
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>DonutDAO Member Page</h1>
        <p>We share Donuts every friday. Donuts are mailed to members in north americas</p>
        <div>
          <div>
            <h2>Member List</h2>
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free Jur🍪DAO Membership NFT</h1>
